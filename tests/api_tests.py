...
class TestAPI(unittest.TestCase):
    ...
    def test_delete_post(self):
        ...
        data = json.loads(response.data.decode("ascii"))
        self.assertEqual(data["message"], "Post 2 successfully deleted")
    ...
    def test_get_non_existent_post(self):
        ...
        data = json.loads(response.data.decode("ascii"))
        self.assertEqual(data["message"], "Could not find a post with id 1")
    ...
    def test_get_posts_with_title(self):
        ...
        postA = models.Post(title="Post with bells", body="Just a teest")
    ...
    def test_get_posts_with_title_and_body(self):
        ...
        response = self.client.get("/api/posts?title_like=whistles&body_like=Another", headers=[("Accept", "application/json")])
